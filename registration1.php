...
if(isset($_POST['reg'])){
    ...
    $ph=$_POST['phno'];
    $p=$_POST['pword'];
    $data=mysqli_query($conn,"insert into registration(name,email,phno,password,rights)values('$n','$e','$ph','$p','user')");
    if($n>0)
            ...
            <div class="form-box login">
                <form action="" method="post">
                    ...
                    <div class="create-account">
                        <p>already have a Account? <a href="login1.php" class="register-link">Sign in</a></p>
                    </div>
                </form>
            </div>
