...
$query=mysqli_query($conn,"select * from viewsup where email='$email'");
$res=mysqli_fetch_array($query);
if(isset($_POST['edit'])){
	$n=$_POST['name'];
	$password=$_POST['password'];
	$r=mysqli_query($conn, "update viewsup set name='$n', password='$password' where email='$email'");
	$query=mysqli_query($conn,"select * from viewsup where email='$email'");
	$res=mysqli_fetch_array($query);
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">SUPPLIER PROFILE</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-lg-10">
